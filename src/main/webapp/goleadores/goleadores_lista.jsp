...
<table class="table table-striped table-hover table-sm" id="RolloGoleadores" style="border: 1px solid #000000; margin: 5px 0">
...
<th style=" color: white; background-color: #9c230b; border: solid 2px white; text-align: center">Goles</th>
...
<td style="text-align: center"><%=f.getGoles() %></td>
...
<img alt="<%=f.getNombrePais() %>" src="https://flagcdn.com/<%=f.getCodigoPais().toLowerCase() %>.svg" style="width: 20px; height: 15px; vertical-align: middle; margin-right: 5px;">
<%} %>
<%=f.getNombrePais() %>
</td>
</tr>
...
<script
	...
	<script>
var table = new DataTable('#RolloGoleadores', {
    language: {
